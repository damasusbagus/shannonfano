...
<body>
<div class="header">Program Kompresi & Steganografi</div>
	<div class="content">
			<div>
				<p>Proses telah selesai<br>
				Silahkan kembali ke menu utama</p>
				<a class="btn btn-success" href="index.php">Kembali Ke Menu Utama</a>
			</div>
		</div>
	</div>
